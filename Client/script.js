...
if (is_logged_in !== 'True') {
  ...
  let valid_user_names = ['RAZABEDI9', 'Sky4222', 'Lakavellari'];
  let all_offers = [];
  ...
  let get_user_data = async (user_name) => {
    const api_endpoint = 'https://paxful.com/pcm/rest/v1/users/' + user_name;
  ...
  // for (let name in valid_user_names) {
  //   get_user_data(valid_user_names[name]);
  // }
